...
\begin{tikzpicture}[>=stealth]
    ...
    \begin{axis}[
       ...
       % grid style={gray!30},
        ...
        \addplot [domain=0:31,blue,thick,name path=A]{18.5};
        
        \addplot[green!50,opacity=0.5] fill between[of=A and B,
        ];

        \node[small dot,pin=120:{Base temperature = \SI{18.5}{\celsius}}] at (axis description cs:0.5,0.74) {};
        \node[font=\small] at (axis description cs:0.2,0.65) {272 degree days in this month};
